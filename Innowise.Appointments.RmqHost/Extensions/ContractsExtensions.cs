...
{
    public static DoctorProfileCreatedCommand MapToCommand(
        this DoctorProfileCreated doctorProfileCreated)
    {
        return new DoctorProfileCreatedCommand(doctorProfileCreated.ProfileId, doctorProfileCreated.FirstName,
                                               doctorProfileCreated.LastName, doctorProfileCreated.MiddleName);
    }

    public static PatientProfileCreatedCommand MapToCommand(
        this PatientProfileCreated patientProfileCreated)
    {
        return new PatientProfileCreatedCommand(patientProfileCreated.ProfileId, patientProfileCreated.FirstName,
                                                patientProfileCreated.LastName, patientProfileCreated.MiddleName,
